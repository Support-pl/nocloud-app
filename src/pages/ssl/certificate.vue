...
<script>
import csr from '@/widgets/services/ssl/csr.vue'
import personal from '@/widgets/services/ssl/personal.vue'
import verification from '@/widgets/services/ssl/verification.vue'
const steps = [
  {
    title: 'CSR',
    content: csr
