    ...
    <div class="container">
      <div class="settings__content">
        ...
        >
          ...
          <add-funds
            :modal-visible="modal.addFunds"
            :hide-modal="hideFunds"
          />
        </div>
...
import addSSH from '@/widgets/appMain/cloud/openCloud/addSSH.vue'
