<template>
  <div class="login">
    ...
    <div class="login__main login__layout">
      <div class="login__UI">
        <div
          v-if="getOnlogin.info"
          class="login__action-info"
        >
          {{ getOnlogin.info }}
        </div>
        ...
        <div class="login__inputs">
          <form>
            ...
            <div
              v-if="invoiceChecked"
              class="inputs__log-pas"
            >
              <input
                v-model="userinfo.companyname"
                :placeholder="$t('clientinfo.companyname') + ' *' | capitalize"
              >
              <span class="login__horisontal-line" />
              <input
              ...
              <input
                ...
                :placeholder="$t('clientinfo.city') + ' *' | capitalize"
              >
              <span class="login__horisontal-line" />
              <input
                v-model="userinfo.postcode"
                :placeholder="$t('clientinfo.postcode') + ' *' | capitalize"
              >
              <span class="login__horisontal-line" />
              <input
                v-model="userinfo.address1"
                :placeholder="$t('clientinfo.address') + ' *' | capitalize"
              >
            </div>
