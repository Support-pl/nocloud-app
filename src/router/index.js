...
//         component: () =>
//           import(
//             `../components/services/${service}/${additionalRoute.componentName}.vue`
//           ),
//       };
//       services.push(route);
//     }
...
const routes = [
  ...
  {
    path: "/",
    component: () => import("../routes/crm.vue"),
    // children: [
    //   {
    //     path: "/",
  ...
  //       name: "openCloud",
  //       component: () =>
  //         import("../components/appMain/cloud/openCloud_new.vue"),
  //     },
  //   ],
  // },
  // {
  ...
  //   },
  //   component: () =>
  //     import("../components/appMain/invoice/openTransaction.vue"),
  // },
  // {
  //   path: "/crm",
  //   name: "crm",
