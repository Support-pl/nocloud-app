        ...
        <a-collapse v-model:activeKey="activeKey" style="border-radius: 20px">
          <a-collapse-panel key="base" :header="`${$t('Base')}:`">
            <div class="order_option">
              <a-row
                v-for="(value, key) in getProducts.base"
                :key="key"
                class="order__prop"
              >
                <a-col span="18">
          ...
          <a-collapse-panel key="adv" :header="`${$t('Advanced')}:`">
            <div class="order_option">
              <a-row
                v-for="(value, key) in getProducts.adv"
                :key="key"
                class="order__prop"
              >
                <a-col span="6">
          ...
          >
            <a-form-item :label="$t('login')">
              <a-input
                ...
                :style="{
                  boxShadow:
                    options.login.length < 2 ? '0 0 2px 2px var(--err)' : null,
                }"
              />
              <div
                v-if="options.login.length < 2"
            ...
            >
              ...
              />
              <a-input-password
                v-model:value="options.password"
                class="password"
              />
            </a-form-item>
          </a-collapse-panel>
  ...
  computed: {
    ...
    getProducts() {
      ...
      Object.entries(this.config).forEach(([key, value]) => {
        ...
        if (key.includes("_adv_") && key !== "local_storage")
          adv[key] = product;
