      ...
      <div class="order__calculate order__field">
        ...
        >
          <a-col v-if="getProducts.prices">
            ...
            <div
              v-else
              class="loadingLine loadingLine--total"
            />
          </a-col>
        </a-row>
  ...
  computed: {
    ...
    template () {
      switch (this.currentStep) {
        case 1:
          return () => import('@/widgets/services/ssl/csr.vue')
        case 2:
          return () => import('@/widgets/services/ssl/personal.vue')
        case 3:
          return () => import('@/widgets/services/ssl/verification.vue')
        default:
          return null
      }
    },
