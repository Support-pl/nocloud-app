<template>
  <div>
    ...
    >
      ...
      />
      <a-form-model-item
        :label="$t('ssl_product.order type')"
        prop="order"
      >
        <a-select
          v-model="personal.order"
      ...
      <a-form-model-item
        :label="$t('ssl_product.webserver type')"
        prop="webserver"
      >
        <a-select
      ...
      <a-form-model-item
        :label="$t('ssl_product.phone number')"
        prop="phonenumber"
      >
      ...
      <div v-if="orgVerification.includes(product_info.id)">
        ...
        <a-form-model-item
          :label="$t('ssl_product.org_country')"
          prop="org_country"
        >
          <a-select
      ...
      <a-form-model-item>
        <a-button
          type="primary"
          @click="$emit('handleClickPrev', personal)"
        >
...
export default {
  ...
  mounted () {
    ...
    if (this.orgVerification.includes(this.product_info.id)) {
      for (const keyField in this.companyFields) {
        this.rules[keyField] = [
          {
