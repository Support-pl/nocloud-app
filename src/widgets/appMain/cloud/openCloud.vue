        ...
        >
          <div class="Fcloud">
            <div class="Fcloud__header">
              ...
              <div
                v-if="SingleCloud.STATE"
                class="Fcloud__header-title"
              >
                <div
...
export default {
  ...
  methods: {
    ...
    chartOption (title) {
      ...
      const localizeTitle = this.$t(title)
      const capitalized = localizeTitle[0].toUpperCase() + localizeTitle.slice(1)
    ...
    ExpandVM () {
      ...
      const url = `/VMresize.php?${this.URLparameter(query)}`
      // console.log(url)
