<template>
  <div class="cloud__fullscreen Fcloud">
    ...
    >
      <div
        v-if="!vmsLoading && VM.billingPlan"
...
export default {
  ...
  computed: {
    ...
    template () {
      const { type = 'ione' } = this.VM.billingPlan ?? {}
      const components = import.meta.glob('@/widgets/appMain/modules/*/openInstance.vue')
