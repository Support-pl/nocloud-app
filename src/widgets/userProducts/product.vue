<template>
  <div class="product">
    <div class="product__icon-wrapper">
      <a-badge
        dot
        :count="wholeProduct.invoicestatus == 'Unpaid' ? 1 : 0"
        :offset="[-10, 2]"
      >
        <div
          class="product__icon"
    ...
    <div class="product__text">
      ...
      <component
        ...
        :service="wholeProduct"
      />
      <div class="product__column product__column--secondary-info">
        <div
          class="product__date"
          :class="{ 'product__date--expired': (isExpired) }"
        >
          {{ localDate }}
        </div>
        <div
...
export default {
  ...
  computed: {
    ...
    getModuleProductBtn () {
      ...
      if (this.wholeProduct.date === 0) return
      return () => import(`@/widgets/services/${serviceType}/lilbtn`)
    }
  },
  created () {
